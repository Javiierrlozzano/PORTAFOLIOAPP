...
<body>
							...
							<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    ...
                                    onclick="event.preventDefault();
                                                document.getElementById('logout-form').submit();"> <i class="demo-pli-unlock icon-lg icon-fw">    </i>Cerrar Sesion
                                            @csrf 
                                        </a>
	...
	<!--Category name-->
                        ...
                        <!--Category name-->
                            <li>
                                <a href="#">
                                <i class="demo-pli-shopping-bag"></i>
                                    <span class="menu-title">Almacen
                                    </span>
                                    <i class="arrow"></i>
                                </a>
                                <!--Submenu-->
                                <ul class="collapse">
                                    <li><a href="{{route('productos.index')}}">Crear Productos</a></li>
                                    <li><a href="{{route('categorias.index')}}">Categorias Productos</a></li>   
                            ...
                            <!--Category name-->
                                <li>
                                    ...
                                    <!--Submenu-->
                                    <ul class="collapse">
                                        <li><a href="{{route('bodegas.index')}}">Crear Bodegas</a></li>
                                        <li><a href="{{route('empresas.index')}}">Empresa</a></li>   
                                        <li><a href="{{route('tipomovimientos.index')}}">Tipo Movimientos</a></li>
